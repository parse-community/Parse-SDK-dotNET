...
namespace ParseTest {
  ...
  public class ObjectTests {
    ...
    public void TestParseObjectCreateWithGeneric() {
      ...
      ParseObject.UnregisterSubclass<SubClass>();
    }
    ...
    public void TestFromState() {
      ...
      ParseObject obj = ParseObject.FromState<ParseObject>(state, "Omitted");
    ...
    public void TestRegisterSubclass() {
      ...
      ParseObject.UnregisterSubclass<UnregisteredSubClass>();
      Assert.DoesNotThrow(() => ParseObject.Create<SubClass>());
    ...
    public void TestDeepTraversal() {
      ...
      IEnumerable<object> traverseResult = ParseObject.DeepTraversal(obj, true, true);
      Assert.AreEqual(8, traverseResult.Count());

      // Don't traverse beyond the root (since root is ParseObject)
      traverseResult = ParseObject.DeepTraversal(obj, false, true);
      Assert.AreEqual(1, traverseResult.Count());

      traverseResult = ParseObject.DeepTraversal(someDict, false, true);
      Assert.AreEqual(2, traverseResult.Count());

      // Should ignore root
      traverseResult = ParseObject.DeepTraversal(obj, true, false);
    ...
    public void TestRemove() {
      ...
      obj = ParseObject.FromState<ParseObject>(state, "Corgi");
    ...
    public void TestGetQuery() {
      ...
      Assert.AreEqual("UnregisteredSubClass", query.ClassName);
