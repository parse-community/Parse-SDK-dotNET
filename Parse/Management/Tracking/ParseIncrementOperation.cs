...
namespace Parse.Core.Internal
{
    public class ParseIncrementOperation : IParseFieldOperation
    {
        ...
        public ParseIncrementOperation(object amount) => this.amount = amount;
        ...
        {
            if (adders.TryGetValue(new Tuple<Type, Type>(obj1.GetType(), obj2.GetType()), out Func<object, object, object> adder))
            {
        ...
        public IParseFieldOperation MergeWithPrevious(IParseFieldOperation previous)
        {
            ...
            {
                object otherAmount = ((ParseSetOperation) previous).Value;
