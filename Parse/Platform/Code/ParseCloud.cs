...
namespace Parse
{
    ...
    {
        internal static IParseCloudCodeController CloudCodeController => ParseCorePlugins.Instance.CloudCodeController;
        ...
        public static Task<T> CallFunctionAsync<T>(string name, IDictionary<string, object> parameters) => CallFunctionAsync<T>(name, parameters, CancellationToken.None);
        ...
        public static Task<T> CallFunctionAsync<T>(string name,
            IDictionary<string, object> parameters, CancellationToken cancellationToken) => CloudCodeController.CallFunctionAsync<T>(name,
                parameters,
