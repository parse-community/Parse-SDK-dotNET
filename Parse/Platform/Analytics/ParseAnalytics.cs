...
namespace Parse
{
    ...
    {
        internal static IParseAnalyticsController AnalyticsController => ParseAnalyticsPlugins.Instance.AnalyticsController;

        internal static IParseCurrentUserController CurrentUserController => ParseAnalyticsPlugins.Instance.CorePlugins.CurrentUserController;
        ...
        /// <returns>An Async Task that can be waited on or ignored.</returns>
        public static Task TrackEventAsync(string name) => TrackEventAsync(name, null);
        ...
        /// <returns>An Async Task that can be waited on or ignored.</returns>
        private static Task TrackAppOpenedWithPushHashAsync(string pushHash = null) => CurrentUserController.GetCurrentSessionTokenAsync(CancellationToken.None)
              .OnSuccess(t =>
              {
