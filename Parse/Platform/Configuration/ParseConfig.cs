...
namespace Parse
{
    ...
    public class ParseConfig : IJsonConvertible
    {
        ...
        internal static void ClearCurrentConfig() => ConfigController.CurrentConfigController.ClearCurrentConfigAsync().Wait();

        internal static void ClearCurrentConfigInMemory() => ConfigController.CurrentConfigController.ClearCurrentConfigInMemoryAsync().Wait();
        ...
        {
            IDictionary<string, object> props = ParseDecoder.Instance.Decode(fetchedConfig["params"]) as IDictionary<string, object>;
            properties = props;
        }
        ...
        public static Task<ParseConfig> GetAsync() => GetAsync(CancellationToken.None);
        ...
        /// <returns>ParseConfig object that was fetched</returns>
        public static Task<ParseConfig> GetAsync(CancellationToken cancellationToken) => ConfigController.FetchConfigAsync(ParseUser.CurrentSessionToken, cancellationToken);
