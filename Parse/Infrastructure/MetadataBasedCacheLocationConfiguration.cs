...
namespace Parse.Infrastructure
{
    ...
    {
        /// <summary>
        /// An instance of <see cref="MetadataBasedCacheLocationConfiguration"/> with inferred values based on the entry assembly. Should be used with <see cref="EnvironmentData.Inferred"/> and <see cref="HostManifestData.Inferred"/>.
        /// </summary>
        /// <remarks>Should not be used with Unity.</remarks>
        public static MetadataBasedCacheLocationConfiguration Inferred => new MetadataBasedCacheLocationConfiguration
        {
        ...
        /// </summary>
        public string GetRelativeStorageFilePath(IServiceHub serviceHub) => Path.Combine(Company ?? nameof(Parse), Product ?? "_global", $"{serviceHub.MetadataController.HostManifestData.ShortVersion ?? "1.0.0.0"}.pc");
    }
}
