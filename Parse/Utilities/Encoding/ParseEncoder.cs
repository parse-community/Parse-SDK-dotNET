...
namespace Parse.Core.Internal
{
    ...
    private static readonly bool isCompiledByIL2CPP = AppDomain.CurrentDomain.FriendlyName.Equals("IL2CPP Root Domain");
        ...
        public static bool IsValidType(object value) => value == null ||
        ...
        public object Encode(object value)
        {
          ...
          {"base64", Convert.ToBase64String(bytes)}
            ...
            ParseObject obj = value as ParseObject;
            if (obj != null)
            {
            ...
            IDictionary<string, object> dict = Conversion.As<IDictionary<string, object>>(value);
            if (dict != null)
            {
            ...
            IParseFieldOperation operation = value as IParseFieldOperation;
            if (operation != null)
            {
