...
namespace LeanCloud.Core.Internal {
  public class AVCommandRunner : IAVCommandRunner {
    ...
    private Task<AVCommand> PrepareCommand(AVCommand command) {
      ...
      newCommand.Headers.Add(new KeyValuePair<string, string>("X-LeanCloud-Application-Id", configuration.ApplicationId));
      ...
      if (!string.IsNullOrEmpty(AVClient.MasterKey)) {
        newCommand.Headers.Add(new KeyValuePair<string, string>("X-LeanCloud-Master-Key", AVClient.MasterKey));
      } else {
        newCommand.Headers.Add(new KeyValuePair<string, string>("X-LeanCloud-Windows-Key", configuration.WindowsKey));
      }
