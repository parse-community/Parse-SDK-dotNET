...
public class ObjectStateTests
{
    ...
    public void MutatedClone_WithNullValues() // 1
    {
        IObjectState state = new MutableObjectState
        {
            ObjectId = "testId"
    ...
    public void MutatedClone_IgnoresExceptions() // 1
    {
        IObjectState state = new MutableObjectState
        {
            ClassName = "Test"
    ...
    public void Decode_ParsesDictionary() // 2
    {
    ...
    public void Decode_HandlesInvalidValues() // 2
    {
        var dict = new Dictionary<string, object>
            {
                { "className", "TestClass" },
    ...
    public void Decode_ReturnsNullForInvalidData() // 1
    {
        IServiceHub mockHub = new Mock<IServiceHub>().Object;
    ...
    public void Apply_WithIncompatibleKey_SkipsKey() // 1
    {
    ...
    public void Apply_OtherStateCopiesCorrectly() // 1
    {
